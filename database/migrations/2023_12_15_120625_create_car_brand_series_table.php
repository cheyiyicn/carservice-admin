...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('car_brand_series', function (Blueprint $table) {
            ...
            $table->string("series_name")->charset("GB2312")->comment("品牌系列名称");
            $table->string("sub_brand_name")->charset("GB2312")->nullable()->default("")->comment("子品牌名称");
            $table->string("image_url")->default("")->comment("图片");
            $table->decimal("official_price_up")->default(0.00)->comment("官方最高售价");
            $table->string("official_price")->charset("GB2312")->default("")->comment("官方售价区间字符串");
            $table->decimal("official_price_down")->default(0.00)->comment("官方最低售价");
            $table->decimal("dealer_price_up")->default(0.00)->comment("经销商最高售价");
            $table->string("dealer_price")->charset("GB2312")->default("")->comment("经销商售价字符串");
            $table->decimal("dealer_price_down")->default(0.00)->comment("经销商最低售价");
            $table->string("category_name")->charset("GB2312")->default("")->comment("汽车分类");
